...
The memory allocation derived from the instruction at
/Users/huziyao/Desktop/MLE/workspace/mod3-Mustache007/minitorch/fast_ops.py
(184) is hoisted out of the parallel loop labelled #1 (it will be performed
before the loop is executed and reused inside the loop):
...
Parallel loop listing for  Function tensor_zip.<locals>._zip, /Users/huziyao/Desktop/MLE/workspace/mod3-Mustache007/minitorch/fast_ops.py (221)
---------------------------------------------------------------------------|loop #ID
    def _zip(                                                              |
        out: Storage,                                                      |
        out_shape: Shape,                                                  |
...
Parallel loop listing for  Function tensor_reduce.<locals>._reduce, /Users/huziyao/Desktop/MLE/workspace/mod3-Mustache007/minitorch/fast_ops.py (281)
---------------------------------------------------------------|loop #ID
    def _reduce(                                               |
        out: Storage,                                          |
        out_shape: Shape,                                      |
...
The memory allocation derived from the instruction at
/Users/huziyao/Desktop/MLE/workspace/mod3-Mustache007/minitorch/fast_ops.py
(293) is hoisted out of the parallel loop labelled #4 (it will be performed
before the loop is executed and reused inside the loop):
...
Parallel loop listing for  Function _tensor_matrix_multiply, /Users/huziyao/Desktop/MLE/workspace/mod3-Mustache007/minitorch/fast_ops.py (308)
-------------------------------------------------------------------------|loop #ID
