...
class TensorData:
    ...
    def index(self, index: Union[int, UserIndex]) -> int:
        """Convert a user-friendly index to a linear index.
        ...
        Raises:
        ------
            IndexingError: If the index is invalid or out of range.
    ...
    def indices(self) -> Iterable[UserIndex]:
        ...
        Returns
        -------
            Iterable[UserIndex]: An iterable of all valid indices.
    ...
    def sample(self) -> UserIndex:
        """Get a random valid index for this tensor.
