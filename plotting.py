...
def run_matmul(backend: minitorch.TensorBackend, size: int = 16) -> None:
    ...
    Args:
    ----
        backend (minitorch.TensorBackend): Backend to use for tensor operations (FastTensorBackend or GPUBackend)
        size (int, optional): Size of the square matrices. Defaults to 16.
    ...
    z = x @ y
    _ = z._tensor  # Force computation without returning
